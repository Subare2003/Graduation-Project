...
window.MQTT_WS_URL = window.location.protocol === 'https:' 
    ? "wss://y8f46cb8.ala.asia-southeast1.emqxsl.com:8084/mqtt"  // Secure WebSocket for HTTPS
    : "ws://y8f46cb8.ala.asia-southeast1.emqxsl.com:8083/mqtt";   // Plain WebSocket for HTTP
